import unittest
from First_Po.page import Wechat
from appium import webdriver
from HTMLTestRunner import HTMLTestRunner
from First_Po.logging_page import *
...
class Touch(unittest.TestCase):
    ...
    def test000(self):
        ...
        #为登录页面断言
        self.assertEqual(self.driver.find_element_by_name('2971966792').text, '297*****792')
        #输入密码
        x.input_passw('li*******456')
        x.loging_enter()
        sleep(4)
